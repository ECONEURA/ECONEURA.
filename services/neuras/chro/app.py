"""
ECONEURA Chief Human Resources Officer (neura-4)
...
tracer, meter = setup_observability("neura-chro", "1.0.0")
instrument_fastapi_app(app, "neura-chro")

# Métricas
request_counter = meter.create_counter(
    "chro_requests_total",
    description="Total requests to Chief Human Resources Officer"
)
error_counter = meter.create_counter(
    "chro_errors_total",
    description="Total errors in Chief Human Resources Officer"
)
...
async def execute_task(
    ...
    """
    with tracer.start_as_current_span("chro_task") as span:
        ...
        try:
            ...
            cursor.execute("""
                ...
                VALUES (%s, %s, %s, %s, %s)
                RETURNING id
            """, ("neura-4", task.user_id, json.dumps(task.input), task.correlation_id, "processing"))
                ...
                response = await client.post(
                    ...
                    json={
                        "messages": [
                            {
                                "role": "system",
                                "content": "You are an HR policies and people management expert. Provide clear, actionable insights based on the data provided."
                            },
                            {
                                "role": "user",
