"""
ECONEURA Analytics Agent (neura-1)
...
# Inicializar FastAPI
app = FastAPI(
    title="ECONEURA Analytics Agent",
    version="1.0.0",
    description="Agent specialized in data analysis, metrics, and reporting"
)
...
request_counter = meter.create_counter(
    ...
    description="Total requests to analytics agent"
)
error_counter = meter.create_counter(
    "analytics_errors_total",
    description="Total errors in analytics agent"
)
...
async def execute_task(
    ...
    """
    with tracer.start_as_current_span("analytics_task") as span:
        ...
        try:
            ...
            cursor.execute("""
                ...
                VALUES (%s, %s, %s, %s, %s)
                RETURNING id
            """, ("neura-1", task.user_id, json.dumps(task.input), task.correlation_id, "processing"))
