"""
ECONEURA Chief Marketing Officer (neura-6)
...
tracer, meter = setup_observability("neura-cmo", "1.0.0")
instrument_fastapi_app(app, "neura-cmo")

# Métricas
request_counter = meter.create_counter(
    "cmo_requests_total",
    description="Total requests to Chief Marketing Officer"
)
error_counter = meter.create_counter(
    "cmo_errors_total",
    description="Total errors in Chief Marketing Officer"
)
...
async def execute_task(
    ...
    """
    with tracer.start_as_current_span("cmo_task") as span:
        ...
        try:
            ...
            cursor.execute("""
                ...
                VALUES (%s, %s, %s, %s, %s)
                RETURNING id
            """, ("neura-6", task.user_id, json.dumps(task.input), task.correlation_id, "processing"))
                ...
                response = await client.post(
                    ...
                    json={
                        "messages": [
                            {
                                "role": "system",
                                "content": "You are an marketing strategies and campaigns expert. Provide clear, actionable insights based on the data provided."
                            },
                            {
                                "role": "user",
