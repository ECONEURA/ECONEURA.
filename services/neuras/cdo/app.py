"""
ECONEURA Chief Data Officer (neura-2)
...
tracer, meter = setup_observability("neura-cdo", "1.0.0")
instrument_fastapi_app(app, "neura-cdo")

# Métricas
request_counter = meter.create_counter(
    "cdo_requests_total",
    description="Total requests to Chief Data Officer"
)
error_counter = meter.create_counter(
    "cdo_errors_total",
    description="Total errors in Chief Data Officer"
)
...
async def execute_task(
    ...
    """
    with tracer.start_as_current_span("cdo_task") as span:
        ...
        try:
            ...
            cursor.execute("""
                ...
                VALUES (%s, %s, %s, %s, %s)
                RETURNING id
            """, ("neura-2", task.user_id, json.dumps(task.input), task.correlation_id, "processing"))
                ...
                response = await client.post(
                    ...
                    json={
                        "messages": [
                            {
                                "role": "system",
                                "content": "You are an data governance and strategy expert. Provide clear, actionable insights based on the data provided."
                            },
                            {
                                "role": "user",
