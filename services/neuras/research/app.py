"""
ECONEURA Research Analyst (neura-10)
...
# Inicializar FastAPI
app = FastAPI(
    title="ECONEURA Research Analyst",
    version="1.0.0",
    description="Agent specialized in Research Analyst responsibilities"
)
...
tracer, meter = setup_observability("neura-research", "1.0.0")
instrument_fastapi_app(app, "neura-research")

# Métricas
request_counter = meter.create_counter(
    "research_requests_total",
    description="Total requests to Research Analyst"
)
error_counter = meter.create_counter(
    "research_errors_total",
    description="Total errors in Research Analyst"
)
    ...
    with tracer.start_as_current_span("research_task") as span:
        ...
        try:
            ...
            cursor.execute("""
                ...
                VALUES (%s, %s, %s, %s, %s)
                RETURNING id
            """, ("neura-10", task.user_id, json.dumps(task.input), task.correlation_id, "processing"))
                ...
                response = await client.post(
                    ...
                    json={
                        "messages": [
                            {
                                "role": "system",
                                "content": "You are an market research and competitive intelligence expert. Provide clear, actionable insights based on the data provided."
                            },
                            {
                                "role": "user",
