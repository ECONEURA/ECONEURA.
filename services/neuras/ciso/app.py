"""
ECONEURA Chief Information Security Officer (neura-5)
...
tracer, meter = setup_observability("neura-ciso", "1.0.0")
instrument_fastapi_app(app, "neura-ciso")

# Métricas
request_counter = meter.create_counter(
    "ciso_requests_total",
    description="Total requests to Chief Information Security Officer"
)
error_counter = meter.create_counter(
    "ciso_errors_total",
    description="Total errors in Chief Information Security Officer"
)
...
async def execute_task(
    ...
    """
    with tracer.start_as_current_span("ciso_task") as span:
        ...
        try:
            ...
            cursor.execute("""
                ...
                VALUES (%s, %s, %s, %s, %s)
                RETURNING id
            """, ("neura-5", task.user_id, json.dumps(task.input), task.correlation_id, "processing"))
                ...
                response = await client.post(
                    ...
                    json={
                        "messages": [
                            {
                                "role": "system",
                                "content": "You are an cybersecurity and compliance expert. Provide clear, actionable insights based on the data provided."
                            },
                            {
                                "role": "user",
